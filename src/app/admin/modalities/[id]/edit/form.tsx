...
import { updateModality } from "@/app/actions/modalities";
...
export default function EditModalityForm({ modality }: EditModalityFormProps) {
    const [state, formAction] = useActionState(updateModality, null);
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white">Editar Modalidade</h1>
                    <p className="text-slate-400">Atualize as informações da modalidade</p>
                </div>
            </div>
                ...
                <form action={formAction} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            name="allowsMixed"
                            className="input-field"
                            defaultValue={modality.allowsMixed ? "true" : "false"}
                            required
                        >
